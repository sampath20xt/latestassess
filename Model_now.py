...
def generate_questions(topics, question_type, difficulty_level, num_questions, additional_requirements):
    prompt = f"""
            ...
            - Based on the difficulty level generate the pseudo questions only do not give any examples.

            For 'subjective' type questions:
            - Generate Subjective type of questions, A clear and open-ended question related to the topic.
            - Based on the difficulty level generate the subjective questions only do not give any examples.
            ...
            For 'pseudo code' type of questions,The output should be a list of dictionaries which consist of question, and correct answer. 
            For 'subjective' type of questions,The output should be a list of dictionaries which consist of question, and correct answer. 
...
def evaluate_answers(questions, answers):
    prompt = f"""
        ...
        correct_answer:
        evaluation: 
        The output should be a list of dictionaries with questions, user_answers, correct_answer, and evaluation. Don't wrap any text or strings to the output.
        """
    generation_config = {
        "max_output_tokens": 8192,
        "temperature": 0.3,
...
def validate_testCases(sceranio, task, code, test_cases):
    prompt = f"""
    ...
    your task is to evaluate the every given code with scenario, task and test with given test cases.
    You have to test and evaluate the given code with given various test cases and scenarios.
    If the code passed in given test cases then the answer will be 'Passed'.
    If the code failed in given any test cases then the answer will be 'Failed'.
